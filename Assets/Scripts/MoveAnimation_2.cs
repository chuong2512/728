...
public class MoveAnimation_2 : MonoBehaviour
{
	...
	public void doEf()
	{
		...
		this.mySequence.Append(base.transform.DOLocalMoveY(this.m_endPos, this.m_duration, false).SetEase(Ease.InSine));
		this.mySequence.Append(base.transform.DOLocalMoveY(this.m_startPos, this.m_duration * 1f, false).SetEase(Ease.OutCubic));
